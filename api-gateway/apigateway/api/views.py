        ...
        if 'application/json' in content_type:
            try:
                ...
                if service_name == 'diseños' and metodo == 'GET':
                    data = replace_internal_urls(data, 'http://api-principal:8001', 'http://88.223.95.55:8001')
                elif service_name == 'noticias' and metodo == 'GET':
                    data = replace_internal_urls(data, 'http://noticiero-api:8002', 'http://88.223.95.55:8002')
