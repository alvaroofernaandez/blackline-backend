"""
Django settings for noticero project.
...
WSGI_APPLICATION = 'noticero.wsgi.application'
...
connect('noticiero', host='localhost', port=27017)  # Ajusta según tu configuración
